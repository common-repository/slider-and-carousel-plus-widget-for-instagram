<?php
/**
 * Plugin Name: Slider and Carousel Plus Widget for Social Media
 * Plugin URI: https://www.essentialplugin.com/wordpress-plugin/slider-and-carousel-plus-widget-for-instagram/
 * Text Domain: slider-and-carousel-plus-widget-for-instagram
...
if( !defined( 'ISCW_VERSION' ) ) {
	define( 'ISCW_VERSION', '1.9.3' ); // Version of plugin
}
if( !defined( 'ISCW_DIR' ) ) {
...
if(!defined( 'ISCW_SITE_LINK' ) ) {
	define('ISCW_SITE_LINK','https://www.essentialplugin.com'); // Plugin link
}
/**
 * Load Text Domain
